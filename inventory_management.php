         ...
         <div class="showcase-products-inner">
            ...
            <?php
               if(isset($_POST['btnadd']))
               {
                 ...
                 <td><input type="text" id="link" name="image" placeholder="URL"></td>
                 </tr>
                ...
                if(isset($_POST['btnupdate']))
                {
                 ...
                 if(isset($_POST['add_item']))
                 {
                   ...
                   $sql = "INSERT INTO `testing`.`kyle_products` (`name`, `code`, `price`, `image`, `desc`) VALUES ('$name', '$code', '$price', '$image', '$desc');";
                 ...
                 if(isset($_POST['update_item']))
                 {
                   ...
                   $sql = "UPDATE `testing`.`kyle_products` SET `name` = '$name', `code` = '$code', `price` = '$price', `image` = '$image', `desc` = '$desc' WHERE (`code` = '$code');";
