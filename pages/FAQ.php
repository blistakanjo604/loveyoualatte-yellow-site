...
<meta http-equiv="X-UA-Compatible" content="ie=edge">
   ...
   <head>
    ...
    <nav class ="navbar navbar-expand-lg navbar-light bg-light">
        <a href="#" class="navbar-brand">Love You A Latte</a>
        <div class="collapse navbar-collapse">

        </div>
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a href="../index.php" class="nav-link">Love You A Latte</a>
            </li>  
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="../products.php" class="nav-link">Product Menu</a>
            </li>  
    ...
    <div class="container showcase-inner">
      ...
      <ul class="no">
		  ...
		  <br>
          <li><h4>Story about why the owner created the first Love You A Latte store:</h4></li>
		  <br>
