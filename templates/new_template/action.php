<?php
	...
	if (isset($_GET['remove'])) {
	  ...
	  $_SESSION['message'] = 'An item has been removed from the cart!';
...
*/
		...
		$query = "SELECT id FROM loveyoualatte.orders ORDER BY id DESC  LIMIT 1;";
		...
		echo '<div class="text-center">
								<h1 class="display-4 mt-2 text-danger">Thank You!</h1>
								<h2 class="text-success">Your Order Placed Successfully!</h2>
								<h4 class="bg-danger text-light rounded p-2">Order ID :</h4>
						  </div>';
